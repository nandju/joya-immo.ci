...
import { Home, Calendar, MessageSquare, Plus, Eye, Edit, Trash2, TrendingUp, Users, FileText } from "lucide-react"
                  ...
                  <tr key={property.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex items-center space-x-2">
                        <Link href={`/proprietaire/proprietes/${property.id}`}>
                          <Button variant="ghost" size="sm" className="text-[#A07539] hover:text-[#252525]">
                            <Eye className="w-4 h-4" />
                          </Button>
                        </Link>
                        <Link href={`/proprietaire/proprietes/${property.id}/editer`}>
                          <Button variant="ghost" size="sm" className="text-[#A07539] hover:text-[#252525]">
