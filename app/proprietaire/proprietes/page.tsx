...
export default function OwnerPropertiesPage() {
  ...
  const handleDesactivate = (id: number) => {
    console.log("Désactiver propriété", id)
  }

  const handleDuplicate = (id: number) => {
    console.log("Dupliquer propriété", id)
  }
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex items-center space-x-2">
                        ...
                        <Button
                          ...
                          onClick={() => handleDesactivate(property.id)}
                        >
                          <Copy className="w-4 h-4" />
                        </Button>
                        <Link href={`/proprietaire/proprietes/${property.id}/avis`}>
                          <Button variant="ghost" size="sm" className="text-[#A07539] hover:text-[#252525]">
                            Avis
                          </Button>
                        </Link>
