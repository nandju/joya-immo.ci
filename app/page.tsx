...
import { MapPin, Bed, Home as HomeIcon, Filter, Search } from "lucide-react"
  ...
  const handleFilter = () => {
    ...
    if (filters.search) {
      filtered = filtered.filter(p => 
        ...
        p.commune.toLowerCase().includes(filters.search.toLowerCase()) ||
        p.locationVague.toLowerCase().includes(filters.search.toLowerCase())
      )
    }
